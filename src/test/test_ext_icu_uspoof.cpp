...
bool TestExtIcu_uspoof::test_SpoofChecker_issuesfound() {
  ...
  VS(ret.getInt64(), q_SpoofChecker___WHOLE_SCRIPT_CONFUSABLE);

  VS(checker->t_issuspicious("f\u0430\u0441\u0435b\u043e\u043ek", ref(ret)),
     true);
  VS(ret.getInt64(), q_SpoofChecker___MIXED_SCRIPT_CONFUSABLE);

  VS(checker->t_areconfusable("hello, world", "he11o, wor1d", ref(ret)), true);
  VS(ret.getInt64(), q_SpoofChecker___SINGLE_SCRIPT_CONFUSABLE);
...
bool TestExtIcu_uspoof::test_SpoofChecker_setchecks() {
  {
    ...
    // case-folded).
    checker->t_setchecks(
      q_SpoofChecker___MIXED_SCRIPT_CONFUSABLE |
      q_SpoofChecker___WHOLE_SCRIPT_CONFUSABLE |
      q_SpoofChecker___SINGLE_SCRIPT_CONFUSABLE
    );
...

  {
    ...
    checker->t_setchecks(q_SpoofChecker___SINGLE_SCRIPT);
