...
-- (5)
HipHop Warning:  Empty keys are not allowed in the definition array in __FILE__ on line 28
bool(false)
HipHop Warning:  Empty keys are not allowed in the definition array in __FILE__ on line 29
bool(false)
bool(false)
array(1) {
  [""]=>
