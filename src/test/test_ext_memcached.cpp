...
bool TestExtMemcached::test_Memcached_construct_persistent() {
  ...
  memc1->t_setoption(q_Memcached___OPT_PREFIX_KEY, "php");
  VS(memc1->t_getoption(q_Memcached___OPT_PREFIX_KEY), "php");

  p_Memcached memc2(p_Memcached(NEWOBJ(c_Memcached))->create("test"));
  VS(memc2->t_getoption(q_Memcached___OPT_PREFIX_KEY), "php");

  p_Memcached memc3(p_Memcached(NEWOBJ(c_Memcached))->create());
  VS(memc3->t_getoption(q_Memcached___OPT_PREFIX_KEY), "");
