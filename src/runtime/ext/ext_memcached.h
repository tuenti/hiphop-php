...
extern const int q_Memcached___OPT_COMPRESSION;
extern const int q_Memcached___OPT_SERIALIZER;
extern const int q_Memcached___SERIALIZER_PHP;
extern const int q_Memcached___SERIALIZER_IGBINARY;
extern const int q_Memcached___SERIALIZER_JSON;
extern const int q_Memcached___OPT_PREFIX_KEY;
extern const int q_Memcached___OPT_HASH;
extern const int q_Memcached___HASH_DEFAULT;
extern const int q_Memcached___HASH_MD5;
extern const int q_Memcached___HASH_CRC;
extern const int q_Memcached___HASH_FNV1_64;
extern const int q_Memcached___HASH_FNV1A_64;
extern const int q_Memcached___HASH_FNV1_32;
extern const int q_Memcached___HASH_FNV1A_32;
extern const int q_Memcached___HASH_HSIEH;
extern const int q_Memcached___HASH_MURMUR;
extern const int q_Memcached___OPT_DISTRIBUTION;
extern const int q_Memcached___DISTRIBUTION_MODULA;
extern const int q_Memcached___DISTRIBUTION_CONSISTENT;
extern const int q_Memcached___OPT_LIBKETAMA_COMPATIBLE;
extern const int q_Memcached___OPT_BUFFER_WRITES;
extern const int q_Memcached___OPT_BINARY_PROTOCOL;
extern const int q_Memcached___OPT_NO_BLOCK;
extern const int q_Memcached___OPT_TCP_NODELAY;
extern const int q_Memcached___OPT_SOCKET_SEND_SIZE;
extern const int q_Memcached___OPT_SOCKET_RECV_SIZE;
extern const int q_Memcached___OPT_CONNECT_TIMEOUT;
extern const int q_Memcached___OPT_RETRY_TIMEOUT;
extern const int q_Memcached___OPT_SEND_TIMEOUT;
extern const int q_Memcached___OPT_RECV_TIMEOUT;
extern const int q_Memcached___OPT_POLL_TIMEOUT;
extern const int q_Memcached___OPT_CACHE_LOOKUPS;
extern const int q_Memcached___OPT_SERVER_FAILURE_LIMIT;
extern const bool q_Memcached___HAVE_IGBINARY;
extern const bool q_Memcached___HAVE_JSON;
extern const int q_Memcached___GET_PRESERVE_ORDER;
extern const int q_Memcached___RES_SUCCESS;
extern const int q_Memcached___RES_FAILURE;
extern const int q_Memcached___RES_HOST_LOOKUP_FAILURE;
extern const int q_Memcached___RES_UNKNOWN_READ_FAILURE;
extern const int q_Memcached___RES_PROTOCOL_ERROR;
extern const int q_Memcached___RES_CLIENT_ERROR;
extern const int q_Memcached___RES_SERVER_ERROR;
extern const int q_Memcached___RES_WRITE_FAILURE;
extern const int q_Memcached___RES_DATA_EXISTS;
extern const int q_Memcached___RES_NOTSTORED;
extern const int q_Memcached___RES_NOTFOUND;
extern const int q_Memcached___RES_PARTIAL_READ;
extern const int q_Memcached___RES_SOME_ERRORS;
extern const int q_Memcached___RES_NO_SERVERS;
extern const int q_Memcached___RES_END;
extern const int q_Memcached___RES_ERRNO;
extern const int q_Memcached___RES_BUFFERED;
extern const int q_Memcached___RES_TIMEOUT;
extern const int q_Memcached___RES_BAD_KEY_PROVIDED;
extern const int q_Memcached___RES_CONNECTION_SOCKET_CREATE_FAILURE;
extern const int q_Memcached___RES_PAYLOAD_FAILURE;
