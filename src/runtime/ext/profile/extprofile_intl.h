...
inline Variant x_collator_asort(CVarRef obj, VRefParam arr, int64 sort_flag = q_Collator___SORT_REGULAR) {
...
inline Variant x_collator_sort(CVarRef obj, VRefParam arr, int64 sort_flag = q_Collator___SORT_REGULAR) {
