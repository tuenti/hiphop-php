...
const int q_SpoofChecker___SINGLE_SCRIPT_CONFUSABLE =
  USPOOF_SINGLE_SCRIPT_CONFUSABLE;
const int q_SpoofChecker___MIXED_SCRIPT_CONFUSABLE =
  USPOOF_MIXED_SCRIPT_CONFUSABLE;
const int q_SpoofChecker___WHOLE_SCRIPT_CONFUSABLE =
  USPOOF_WHOLE_SCRIPT_CONFUSABLE;
const int q_SpoofChecker___ANY_CASE = USPOOF_ANY_CASE;
const int q_SpoofChecker___SINGLE_SCRIPT = USPOOF_SINGLE_SCRIPT;
const int q_SpoofChecker___INVISIBLE = USPOOF_INVISIBLE;
const int q_SpoofChecker___CHAR_LIMIT = USPOOF_CHAR_LIMIT;
