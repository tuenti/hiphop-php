...
void f_hphp_recursiveiteratoriterator_next(CObjRef obj) {
  ...
  if (rii->m_mode == HPHP::q_RecursiveIteratorIterator___SELF_FIRST) {
  ...
  } else if (rii->m_mode == HPHP::q_RecursiveIteratorIterator___CHILD_FIRST ||
             rii->m_mode == HPHP::q_RecursiveIteratorIterator___LEAVES_ONLY) {
    if (!ci.is<RecursiveDirectoryIterator>()) {
      throw NotImplementedException("this type of iterator");
    }
    RecursiveDirectoryIterator *rdi =
    ...
    if (pathName.empty()) {
      ...
      if (!rii->m_iterators[size-1].second) {
        ...
        if (rii->m_mode == HPHP::q_RecursiveIteratorIterator___CHILD_FIRST &&
          rii->m_iterators[size-1].second == 1) {
...
bool f_hphp_recursiveiteratoriterator_valid(CObjRef obj) {
  ...
  if (rii->m_iterators[size-1].first.is<RecursiveDirectoryIterator>()) {
    ...
    if (valid) {
      if (rii->m_mode == HPHP::q_RecursiveIteratorIterator___LEAVES_ONLY ||
          rii->m_mode == HPHP::q_RecursiveIteratorIterator___CHILD_FIRST) {
        String pathName = rdi->getPathName();
...
Variant f_hphp_recursivedirectoryiterator_key(CObjRef obj) {
  ...
  if (rdi->m_flags == HPHP::q_RecursiveDirectoryIterator___KEY_AS_FILENAME) {
...
Variant f_hphp_recursivedirectoryiterator_current(CObjRef obj) {
  RecursiveDirectoryIterator *rdi = get_recursivedirectoryiterator(obj);
  String pathName = rdi->getPathName();
  if (rdi->m_flags & HPHP::q_RecursiveDirectoryIterator___CURRENT_AS_PATHNAME) {
    return pathName;
  }
  if (rdi->m_flags & HPHP::q_RecursiveDirectoryIterator___CURRENT_AS_FILEINFO) {
