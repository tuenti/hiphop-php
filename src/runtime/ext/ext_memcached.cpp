...
// Class options
const int q_Memcached___OPT_COMPRESSION = -1001;
const int q_Memcached___OPT_PREFIX_KEY  = -1002;
const int q_Memcached___OPT_SERIALIZER  = -1003;

// Indicate whether igbinary serializer is available
const bool q_Memcached___HAVE_IGBINARY = false;

// Indicate whether json serializer is available
const bool q_Memcached___HAVE_JSON = true;

// libmemcached behavior options
const int q_Memcached___OPT_HASH
          = MEMCACHED_BEHAVIOR_HASH;
const int q_Memcached___HASH_DEFAULT
          = MEMCACHED_HASH_DEFAULT;
const int q_Memcached___HASH_MD5
          = MEMCACHED_HASH_MD5;
const int q_Memcached___HASH_CRC
          = MEMCACHED_HASH_CRC;
const int q_Memcached___HASH_FNV1_64
          = MEMCACHED_HASH_FNV1_64;
const int q_Memcached___HASH_FNV1A_64
          = MEMCACHED_HASH_FNV1A_64;
const int q_Memcached___HASH_FNV1_32
          = MEMCACHED_HASH_FNV1_32;
const int q_Memcached___HASH_FNV1A_32
          = MEMCACHED_HASH_FNV1A_32;
const int q_Memcached___HASH_HSIEH
          = MEMCACHED_HASH_HSIEH;
const int q_Memcached___HASH_MURMUR
          = MEMCACHED_HASH_MURMUR;
const int q_Memcached___OPT_DISTRIBUTION
          = MEMCACHED_BEHAVIOR_DISTRIBUTION;
const int q_Memcached___DISTRIBUTION_MODULA
          = MEMCACHED_DISTRIBUTION_MODULA;
const int q_Memcached___DISTRIBUTION_CONSISTENT
          = MEMCACHED_DISTRIBUTION_CONSISTENT;
const int q_Memcached___OPT_LIBKETAMA_COMPATIBLE
          = MEMCACHED_BEHAVIOR_KETAMA_WEIGHTED;
const int q_Memcached___OPT_BUFFER_WRITES
          = MEMCACHED_BEHAVIOR_BUFFER_REQUESTS;
const int q_Memcached___OPT_BINARY_PROTOCOL
          = MEMCACHED_BEHAVIOR_BINARY_PROTOCOL;
const int q_Memcached___OPT_NO_BLOCK
          = MEMCACHED_BEHAVIOR_NO_BLOCK;
const int q_Memcached___OPT_TCP_NODELAY
          = MEMCACHED_BEHAVIOR_TCP_NODELAY;
const int q_Memcached___OPT_SOCKET_SEND_SIZE
          = MEMCACHED_BEHAVIOR_SOCKET_SEND_SIZE;
const int q_Memcached___OPT_SOCKET_RECV_SIZE
          = MEMCACHED_BEHAVIOR_SOCKET_RECV_SIZE;
const int q_Memcached___OPT_CONNECT_TIMEOUT
          = MEMCACHED_BEHAVIOR_CONNECT_TIMEOUT;
const int q_Memcached___OPT_RETRY_TIMEOUT
          = MEMCACHED_BEHAVIOR_RETRY_TIMEOUT;
const int q_Memcached___OPT_SEND_TIMEOUT
          = MEMCACHED_BEHAVIOR_SND_TIMEOUT;
const int q_Memcached___OPT_RECV_TIMEOUT
          = MEMCACHED_BEHAVIOR_RCV_TIMEOUT;
const int q_Memcached___OPT_POLL_TIMEOUT
          = MEMCACHED_BEHAVIOR_POLL_TIMEOUT;
const int q_Memcached___OPT_CACHE_LOOKUPS
          = MEMCACHED_BEHAVIOR_CACHE_LOOKUPS;
const int q_Memcached___OPT_SERVER_FAILURE_LIMIT
          = MEMCACHED_BEHAVIOR_SERVER_FAILURE_LIMIT;

// libmemcached result codes
const int q_Memcached___RES_SUCCESS
          = MEMCACHED_SUCCESS;
const int q_Memcached___RES_FAILURE
          = MEMCACHED_FAILURE;
const int q_Memcached___RES_HOST_LOOKUP_FAILURE
          = MEMCACHED_HOST_LOOKUP_FAILURE;
const int q_Memcached___RES_UNKNOWN_READ_FAILURE
          = MEMCACHED_UNKNOWN_READ_FAILURE;
const int q_Memcached___RES_PROTOCOL_ERROR
          = MEMCACHED_PROTOCOL_ERROR;
const int q_Memcached___RES_CLIENT_ERROR
          = MEMCACHED_CLIENT_ERROR;
const int q_Memcached___RES_SERVER_ERROR
          = MEMCACHED_SERVER_ERROR;
const int q_Memcached___RES_WRITE_FAILURE
          = MEMCACHED_WRITE_FAILURE;
const int q_Memcached___RES_DATA_EXISTS
          = MEMCACHED_DATA_EXISTS;
const int q_Memcached___RES_NOTSTORED
          = MEMCACHED_NOTSTORED;
const int q_Memcached___RES_NOTFOUND
          = MEMCACHED_NOTFOUND;
const int q_Memcached___RES_PARTIAL_READ
          = MEMCACHED_PARTIAL_READ;
const int q_Memcached___RES_SOME_ERRORS
          = MEMCACHED_SOME_ERRORS;
const int q_Memcached___RES_NO_SERVERS
          = MEMCACHED_NO_SERVERS;
const int q_Memcached___RES_END
          = MEMCACHED_END;
const int q_Memcached___RES_ERRNO
          = MEMCACHED_ERRNO;
const int q_Memcached___RES_BUFFERED
          = MEMCACHED_BUFFERED;
const int q_Memcached___RES_TIMEOUT
          = MEMCACHED_TIMEOUT;
const int q_Memcached___RES_BAD_KEY_PROVIDED
          = MEMCACHED_BAD_KEY_PROVIDED;
const int q_Memcached___RES_CONNECTION_SOCKET_CREATE_FAILURE
          = MEMCACHED_CONNECTION_SOCKET_CREATE_FAILURE;

// Our result codes
const int q_Memcached___RES_PAYLOAD_FAILURE = -1001;

// Serializer types
const int q_Memcached___SERIALIZER_PHP      = 1;
const int q_Memcached___SERIALIZER_IGBINARY = 2;
const int q_Memcached___SERIALIZER_JSON     = 3;

// Flags
const int q_Memcached___GET_PRESERVE_ORDER = 1;
...
c_Memcached::Impl::Impl() :
    compression(true),
    serializer(q_Memcached___SERIALIZER_PHP),
    rescode(q_Memcached___RES_SUCCESS) {
...
Variant c_Memcached::t_getbykey(CStrRef server_key, CStrRef key,
  ...
  TAINT_OBSERVER(TAINT_BIT_ALL, TAINT_BIT_NONE);
  m_impl->rescode = q_Memcached___RES_SUCCESS;
  if (key.empty()) {
    m_impl->rescode = q_Memcached___RES_BAD_KEY_PROVIDED;
    return false;
  }
  ...
  if (!toObject(returnValue, result.value)) {
    m_impl->rescode = q_Memcached___RES_PAYLOAD_FAILURE;
    return false;
  }
...
Variant c_Memcached::t_getmultibykey(CStrRef server_key, CArrRef keys,
  ...
  bool preserveOrder = flags & q_Memcached___GET_PRESERVE_ORDER;
  Array returnValue;
...
bool c_Memcached::t_getdelayedbykey(CStrRef server_key, CArrRef keys,
  ...
  if (m_impl->rescode != q_Memcached___RES_END) return false;
  m_impl->rescode = q_Memcached___RES_SUCCESS;
  return true;
}
...
Variant c_Memcached::t_getoption(int option) {
  ...
  switch (option) {
  case q_Memcached___OPT_COMPRESSION:
    return m_impl->compression;

  case q_Memcached___OPT_PREFIX_KEY:
    {
  ...
  case q_Memcached___OPT_SERIALIZER:
  ...
  case q_Memcached___OPT_SERIALIZER:
    {
      ...
      switch (iValue) {
      case q_Memcached___SERIALIZER_PHP:
      case q_Memcached___SERIALIZER_JSON:
        m_impl->serializer = iValue;
        break;
      default:
        m_impl->serializer = q_Memcached___SERIALIZER_PHP;
...
String c_Memcached::t_getresultmessage() {
  ...
  if (m_impl->rescode == q_Memcached___RES_PAYLOAD_FAILURE) {
