...
void init_builtin_constant_table() {
  const char *conMapData[] = {
      ...
      (const char *)"CAL_GREGORIAN", (const char *)-1, (const char *)32, (const char *)&k_CAL_GREGORIAN,
      ...
      (const char *)"FILTER_DEFAULT", (const char *)-1, (const char *)32, (const char *)&k_FILTER_DEFAULT,
      (const char *)"FILTER_FLAG_ALLOW_FRACTION", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_ALLOW_FRACTION,
      (const char *)"FILTER_FLAG_ALLOW_HEX", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_ALLOW_HEX,
      (const char *)"FILTER_FLAG_ALLOW_OCTAL", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_ALLOW_OCTAL,
      (const char *)"FILTER_FLAG_ALLOW_SCIENTIFIC", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_ALLOW_SCIENTIFIC,
      (const char *)"FILTER_FLAG_ALLOW_THOUSAND", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_ALLOW_THOUSAND,
      (const char *)"FILTER_FLAG_EMPTY_STRING_NULL", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_EMPTY_STRING_NULL,
      (const char *)"FILTER_FLAG_ENCODE_AMP", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_ENCODE_AMP,
      (const char *)"FILTER_FLAG_ENCODE_HIGH", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_ENCODE_HIGH,
      (const char *)"FILTER_FLAG_ENCODE_LOW", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_ENCODE_LOW,
      (const char *)"FILTER_FLAG_HOST_REQUIRED", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_HOST_REQUIRED,
      (const char *)"FILTER_FLAG_IPV4", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_IPV4,
      (const char *)"FILTER_FLAG_IPV6", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_IPV6,
      (const char *)"FILTER_FLAG_NONE", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_NONE,
      (const char *)"FILTER_FLAG_NO_ENCODE_QUOTES", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_NO_ENCODE_QUOTES,
      (const char *)"FILTER_FLAG_NO_PRIV_RANGE", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_NO_PRIV_RANGE,
      (const char *)"FILTER_FLAG_NO_RES_RANGE", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_NO_RES_RANGE,
      (const char *)"FILTER_FLAG_PATH_REQUIRED", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_PATH_REQUIRED,
      (const char *)"FILTER_FLAG_QUERY_REQUIRED", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_QUERY_REQUIRED,
      (const char *)"FILTER_FLAG_SCHEME_REQUIRED", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_SCHEME_REQUIRED,
      (const char *)"FILTER_FLAG_STRIP_BACKTICK", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_STRIP_BACKTICK,
      (const char *)"FILTER_FLAG_STRIP_HIGH", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_STRIP_HIGH,
      (const char *)"FILTER_FLAG_STRIP_LOW", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FLAG_STRIP_LOW,
      (const char *)"FILTER_FORCE_ARRAY", (const char *)-1, (const char *)32, (const char *)&k_FILTER_FORCE_ARRAY,
      (const char *)"FILTER_NULL_ON_FAILURE", (const char *)-1, (const char *)32, (const char *)&k_FILTER_NULL_ON_FAILURE,
      (const char *)"FILTER_REQUIRE_ARRAY", (const char *)-1, (const char *)32, (const char *)&k_FILTER_REQUIRE_ARRAY,
      (const char *)"FILTER_REQUIRE_SCALAR", (const char *)-1, (const char *)32, (const char *)&k_FILTER_REQUIRE_SCALAR,
      (const char *)"FILTER_SANITIZE_EMAIL", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_EMAIL,
      (const char *)"FILTER_SANITIZE_ENCODED", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_ENCODED,
      (const char *)"FILTER_SANITIZE_FULL_SPECIAL_CHARS", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_FULL_SPECIAL_CHARS,
      (const char *)"FILTER_SANITIZE_MAGIC_QUOTES", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_MAGIC_QUOTES,
      (const char *)"FILTER_SANITIZE_NUMBER_FLOAT", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_NUMBER_FLOAT,
      (const char *)"FILTER_SANITIZE_NUMBER_INT", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_NUMBER_INT,
      (const char *)"FILTER_SANITIZE_SPECIAL_CHARS", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_SPECIAL_CHARS,
      (const char *)"FILTER_SANITIZE_STRING", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_STRING,
      (const char *)"FILTER_SANITIZE_STRIPPED", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_STRIPPED,
      (const char *)"FILTER_SANITIZE_URL", (const char *)-1, (const char *)32, (const char *)&k_FILTER_SANITIZE_URL,
      (const char *)"FILTER_UNSAFE_RAW", (const char *)-1, (const char *)32, (const char *)&k_FILTER_UNSAFE_RAW,
      (const char *)"FILTER_VALIDATE_BOOLEAN", (const char *)-1, (const char *)32, (const char *)&k_FILTER_VALIDATE_BOOLEAN,
      (const char *)"FILTER_VALIDATE_EMAIL", (const char *)-1, (const char *)32, (const char *)&k_FILTER_VALIDATE_EMAIL,
      (const char *)"FILTER_VALIDATE_FLOAT", (const char *)-1, (const char *)32, (const char *)&k_FILTER_VALIDATE_FLOAT,
      (const char *)"FILTER_VALIDATE_INT", (const char *)-1, (const char *)32, (const char *)&k_FILTER_VALIDATE_INT,
      (const char *)"FILTER_VALIDATE_IP", (const char *)-1, (const char *)32, (const char *)&k_FILTER_VALIDATE_IP,
      ...
      (const char *)"INPUT_COOKIE", (const char *)-1, (const char *)32, (const char *)&k_INPUT_COOKIE,
      (const char *)"INPUT_ENV", (const char *)-1, (const char *)32, (const char *)&k_INPUT_ENV,
      (const char *)"INPUT_GET", (const char *)-1, (const char *)32, (const char *)&k_INPUT_GET,
      (const char *)"INPUT_POST", (const char *)-1, (const char *)32, (const char *)&k_INPUT_POST,
      (const char *)"INPUT_REQUEST", (const char *)-1, (const char *)32, (const char *)&k_INPUT_REQUEST,
      ...
      (const char *)"MEMCACHE_HASH_CRC32", (const char *)-1, (const char *)32, (const char *)&k_MEMCACHE_HASH_CRC32,
      (const char *)"MEMCACHE_HASH_FNV", (const char *)-1, (const char *)32, (const char *)&k_MEMCACHE_HASH_FNV,
      (const char *)"MEMCACHE_HASH_MURMUR", (const char *)-1, (const char *)32, (const char *)&k_MEMCACHE_HASH_MURMUR,
